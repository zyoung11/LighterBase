...
![数据库创建界面](/docs/imgs/Database_create.webp)
...
![GOJS E-R 图渲染](/docs/imgs/Database_gojs.webp)
...
![API 文档界面](/docs/imgs/Database_apimd.webp)

**重要提醒：表结构提交后无法修改，请仔细检查后再确认！**

<h4 style="font-weight: bold; font-size: 1.2em;">🔒 权限管理模块</h4>

![权限管理界面](/docs/imgs/Database_permission.webp)
...
![日志管理页面](/docs/imgs/log_info.webp)
...
![AI 设置模块](/docs/imgs/setting_ai.webp)
...
![账户设置模块](/docs/imgs/setting_account.webp)

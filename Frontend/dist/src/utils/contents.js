var f=Object.create;var{getPrototypeOf:x,defineProperty:s,getOwnPropertyNames:D}=Object;var V=Object.prototype.hasOwnProperty;var P=(l,i,w)=>{w=l!=null?f(x(l)):{};let t=i||!l||!l.__esModule?s(w,"default",{value:l,enumerable:!0}):w;for(let a of D(l))if(!V.call(t,a))s(t,a,{get:()=>l[a],enumerable:!0});return t};var B=(l,i)=>()=>(i||l((i={exports:{}}).exports,i),i.exports);var d="../../api白-svfmcn1w.svg";var h="../../message_light-z62d1mdh.svg";var r="../../勾白-7mfe7pbc.svg";var n="../../扩大白-neahdehm.svg";var e="../../level白-s87vgjz1.svg";var v="../../page白-thsavq0n.svg";var p="../../date白-a0y3wgpq.svg";var c="../../create白-43pgf0gt.svg";var g="../../权限白-tyx9qvg0.svg";var o="../../用户白-gtqyzett.svg";var _={logo:`
                <div class="space-y-3">
                ...
                <div class="flex-1 flex flex-col">
                    ...
                    <div class="h-[60%]  p-6 relative">
                        ...
                        <button id="api-docs-btn" class="absolute w-12 h-12 right-10 top-1/2 transform -translate-y-1/2 px-3 py-2 rounded transition-colors z-10">
                            <img src ="${d}" class ="object-contain" alt="API文档">
                        </button>
                    </div>
        ...
        <tr class="border-b border-gray-600">
          ...
          <th class="px-3 py-2 text-left flex items-center">
            <div class="flex items-center">
              <img src="${e}" class="w-3 h-3 object-contain" alt="查看完整SQL ">
              <p>Level</p>
            </div>
          </th>
          ...
          <th class="px-3 py-2">
            <div class="flex items-center">
              <img src="${v}" class="w-5 h-5 object-contain" alt="日志内容 ">
              <p>日志内容</p>
            </div>
          </th>
          <th class="px-3 py-2 text-left flex items-center">
            <div class="flex items-center">
              <img src="${p}" class="w-3 h-3 object-contain" alt="创建时间 ">
              <p>创建时间</p>
            </div>
          </th>
        </tr>
...
`};export{l3 as workspaceContent,i3 as slideBarContent,_ as sidebarContent,w3 as apiMarked};
